...
class RateViewData constructor(val startNumber: String, val progress: Int) : BaseRecyclerData {

    companion object {
        val VIEW_TYPE: Int = ir.pattern.udemyredesign.R.layout.holder_rate_item
    }
